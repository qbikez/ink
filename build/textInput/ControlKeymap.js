...
const defaultEnter = [{ key: "return" }, { input: "i" }];
const defaultExit = [{ key: "return" }, { key: "esc" }];
const EVENTS = {
    return: "return",
    left: "left",
    right: "right",
...
function getDefaultInsertKeymap(opts) {
    const ignore = ["left", "right", "up", "down", "backspace"];
...
function getNormalKeymap(ID, enterKeyInput) {
 ...
 * */
function getInsertKeymap(ID, exitKeyInput, opts) {
    ...
    for (const [key, value] of Object.entries(defaultInsert)) {
        ...
        if (key === EVENTS.keypress) {
            defaultInsert[scopedKey] = {
                ...value,
                notKey: [...notKey, ...value.notKey],
                notInput: [...notInput, ...value.notInput],
            };
        }
        else {
...
//# sourceMappingURL=ControlKeymap.js.map