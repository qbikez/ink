...
const renderBorder = (x, y, node, output, zIndexRoot) => {
    const hasTopTitle = node.style.titleTopLeft || node.style.titleTopCenter || node.style.titleTopRight;
    const hasBottomTitle = node.style.titleBottomLeft ||
